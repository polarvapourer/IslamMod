...
- [Download IslamMod version 1.0.1](https://github.com/polarvapourer/IslamMod/releases/tag/v1.0.1)
...
3. Copy `IslamMod-1.0.1.jar` directly into the `mods` folder for that Forge installation. On Windows, this is normally `%APPDATA%\.minecraft\mods`. Do not put it in a version subfolder such as `%APPDATA%\.minecraft\mods\26.2`.
